 ...
 */
class SladCalendarApiExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        if ($container->hasDefinition('slad.google_calendar')) {
            $definition = $container->getDefinition('slad.google_calendar');
